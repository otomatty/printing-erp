      ...
      <div className="bg-white p-6 rounded-lg shadow">
        <div className="flex items-start justify-between">
          <div>
            ...
            <p className="text-3xl font-bold mt-1">{mockStats.pendingOrders}</p>
          </div>
      ...
      <div className="bg-white p-6 rounded-lg shadow">
        <div className="flex items-start justify-between">
          <div>
            ...
            <p className="text-3xl font-bold mt-1">{mockStats.lowStockItems}</p>
          </div>
      ...
      <div className="bg-white p-6 rounded-lg shadow">
        <div className="flex items-start justify-between">
          <div>
            ...
            <p className="text-3xl font-bold mt-1">{mockStats.scheduledJobs}</p>
          </div>
