...
import { getIconForItem } from './comparison-icons';

const SystemWhyChooseUsSection: React.FC = () => {
  return (
    <section className="py-16 lg:py-32 bg-blue-50">
      <Container>
        <h2 className="text-3xl lg:text-4xl font-bold text-center mb-2">
          ニイヌマ企画印刷が<span className="text-blue-600">選ばれる理由</span>
        </h2>

        <p className="text-lg text-center text-gray-700 mb-12 max-w-3xl mx-auto">
          私たちはただシステムを作るだけでなく、お客様の事業の成功を
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="w-full md:w-1/2">
              <h3 className="text-2xl font-bold mb-4">
                <span className="text-blue-600">システム会社ではなく</span>
                <br />
                気軽に相談できる身近なパートナー
              </h3>
              <p className="text-gray-700 mb-6">
                「システムのことはよくわからない」というお客様でも安心して相談できる関係づくりを大切にしています。
                専門用語を使わず、わかりやすく説明し、導入後も困ったときにすぐ対応します。
              </p>
