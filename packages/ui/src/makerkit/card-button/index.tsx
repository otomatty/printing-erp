...
> = function CardButton({ className, asChild, ...props }) {
  ...
  return (
    <Comp
      className={cn(
        'group hover:bg-secondary/20 active:bg-secondary/50 dark:shadow-primary/20 relative flex h-36 flex-col rounded-lg border transition-all hover:shadow-xs active:shadow-lg',
        className
      )}
      {...props}
    >
