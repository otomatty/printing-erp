...
__export(sign_in_exports, {
  PasswordSignInSchema: () => PasswordSignInSchema,
...
var import_use_sign_in_with_email_password = require("@kit/supabase/hooks/use-sign-in-with-email-password");
...
// src/schemas/password-sign-in.schema.ts
var PasswordSignInSchema = import_zod4.z.object({
...
function PasswordSignInForm({
  ...
  const form = (0, import_react_hook_form2.useForm)({
    resolver: (0, import_zod5.zodResolver)(PasswordSignInSchema),
    defaultValues: {
      email: "",
      password: ""
    }
  ...
  return /* @__PURE__ */ React.createElement(import_form3.Form, { ...form }, /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(
      import_form3.FormField,
      {
        ...
        render: ({ field }) => /* @__PURE__ */ React.createElement(import_form3.FormItem, null, /* @__PURE__ */ React.createElement(import_form3.FormLabel, null, "\u30D1\u30B9\u30EF\u30FC\u30C9"), /* @__PURE__ */ React.createElement(import_form3.FormControl, null, /* @__PURE__ */ React.createElement(
        ...
        )), /* @__PURE__ */ React.createElement(import_form3.FormMessage, null), /* @__PURE__ */ React.createElement(
          ...
          /* @__PURE__ */ React.createElement(import_link2.default, { href: "/auth/password-reset" }, "\u30D1\u30B9\u30EF\u30FC\u30C9\u3092\u304A\u5FD8\u308C\u3067\u3059\u304B\uFF1F")
        ))
      }
    ),
    /* @__PURE__ */ React.createElement(
...
function PasswordSignInContainer({
  ...
  const { captchaToken, resetCaptchaToken } = useCaptchaToken();
  const signInMutation = (0, import_use_sign_in_with_email_password.useSignInWithEmailPassword)();
...
function SignInMethodsContainer(props) {
  ...
  const redirectUrl = (0, import_utils2.isBrowser)() ? new URL(props.paths.callback, window.location.origin).toString() : "";
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(import_if4.If, { condition: props.providers.password }, /* @__PURE__ */ React.createElement(PasswordSignInContainer, { onSignIn: handlePasswordSignIn })), /* @__PURE__ */ React.createElement(import_if4.If, { condition: props.providers.magicLink }, /* @__PURE__ */ React.createElement(
    MagicLinkAuthContainer,
    {
      redirectUrl,
      shouldCreateUser: false
    }
  )), /* @__PURE__ */ React.createElement(import_if4.If, { condition: props.providers.oAuth.length }, /* @__PURE__ */ React.createElement(import_separator.Separator, null), /* @__PURE__ */ React.createElement(
    OauthProviders,
    {
