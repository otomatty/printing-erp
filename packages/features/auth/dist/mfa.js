...
var import_use_sign_out = require("@kit/supabase/hooks/use-sign-out");
...
function MultiFactorChallengeContainer({
  ...
  const verificationCodeForm = (0, import_react_hook_form.useForm)({
    resolver: (0, import_zod.zodResolver)(
      import_zod2.z.object({
        factorId: import_zod2.z.string().min(1),
        verificationCode: import_zod2.z.string().min(6).max(6)
      })
    ),
    defaultValues: {
      factorId: "",
  ...
  const factorId = (0, import_react_hook_form.useWatch)({
    name: "factorId",
  ...
  return /* @__PURE__ */ React.createElement(import_form.Form, { ...verificationCodeForm }, /* @__PURE__ */ React.createElement(
    "form",
    {
      className: "w-full",
    ...
    /* @__PURE__ */ React.createElement("div", { className: "flex flex-col space-y-4" }, /* @__PURE__ */ React.createElement("span", { className: "text-muted-foreground text-sm" }, "\u8A8D\u8A3C\u30A2\u30D7\u30EA\u306B\u8868\u793A\u3055\u308C\u305F6\u6841\u306E\u30B3\u30FC\u30C9\u3092\u5165\u529B\u3057\u3066\u304F\u3060\u3055\u3044"), /* @__PURE__ */ React.createElement("div", { className: "flex w-full flex-col space-y-2.5" }, /* @__PURE__ */ React.createElement("div", { className: "flex flex-col space-y-4" }, /* @__PURE__ */ React.createElement(import_if.If, { condition: verifyMFAChallenge.error }, /* @__PURE__ */ React.createElement(import_alert.Alert, { variant: "destructive" }, /* @__PURE__ */ React.createElement(import_react_icons.ExclamationTriangleIcon, { className: "h-5" }), /* @__PURE__ */ React.createElement(import_alert.AlertTitle, null, "\u8A8D\u8A3C\u30B3\u30FC\u30C9\u304C\u7121\u52B9\u3067\u3059"), /* @__PURE__ */ React.createElement(import_alert.AlertDescription, null, "\u5165\u529B\u3055\u308C\u305F\u30B3\u30FC\u30C9\u304C\u6B63\u3057\u304F\u3042\u308A\u307E\u305B\u3093\u3002\u3082\u3046\u4E00\u5EA6\u304A\u8A66\u3057\u304F\u3060\u3055\u3044\u3002"))), /* @__PURE__ */ React.createElement(
      import_form.FormField,
      {
        name: "verificationCode",
        render: ({ field }) => {
          return /* @__PURE__ */ React.createElement(
            import_form.FormItem,
            {
              className: "mx-auto flex flex-col items-center justify-center"
            },
            /* @__PURE__ */ React.createElement(import_form.FormControl, null, /* @__PURE__ */ React.createElement(import_input_otp.InputOTP, { ...field, maxLength: 6, minLength: 6 }, /* @__PURE__ */ React.createElement(import_input_otp.InputOTPGroup, null, /* @__PURE__ */ React.createElement(import_input_otp.InputOTPSlot, { index: 0 }), /* @__PURE__ */ React.createElement(import_input_otp.InputOTPSlot, { index: 1 }), /* @__PURE__ */ React.createElement(import_input_otp.InputOTPSlot, { index: 2 })), /* @__PURE__ */ React.createElement(import_input_otp.InputOTPSeparator, null), /* @__PURE__ */ React.createElement(import_input_otp.InputOTPGroup, null, /* @__PURE__ */ React.createElement(import_input_otp.InputOTPSlot, { index: 3 }), /* @__PURE__ */ React.createElement(import_input_otp.InputOTPSlot, { index: 4 }), /* @__PURE__ */ React.createElement(import_input_otp.InputOTPSlot, { index: 5 })))),
            /* @__PURE__ */ React.createElement(import_form.FormDescription, null, "\u8A8D\u8A3C\u30A2\u30D7\u30EA\u306B\u8868\u793A\u3055\u308C\u305F6\u6841\u306E\u30B3\u30FC\u30C9\u3092\u5165\u529B\u3057\u3066\u304F\u3060\u3055\u3044"),
...
function useVerifyMFAChallenge({ onSuccess }) {
  ...
  return (0, import_react_query.useMutation)({ mutationKey, mutationFn, onSuccess });
}
function FactorsListContainer({
  onSelect,
  userId
}) {
  const signOut = (0, import_use_sign_out.useSignOut)();
  const { data: factors, isLoading, error } = (0, import_use_fetch_mfa_factors.useFetchAuthFactors)(userId);
  ...
  if (isLoading) {
    return /* @__PURE__ */ React.createElement("div", { className: "flex flex-col items-center space-y-4 py-8" }, /* @__PURE__ */ React.createElement(import_spinner.Spinner, null), /* @__PURE__ */ React.createElement("div", null, "\u8A8D\u8A3C\u65B9\u6CD5\u3092\u8AAD\u307F\u8FBC\u307F\u4E2D..."));
  }
  if (error) {
    return /* @__PURE__ */ React.createElement("div", { className: "w-full" }, /* @__PURE__ */ React.createElement(import_alert.Alert, { variant: "destructive" }, /* @__PURE__ */ React.createElement(import_react_icons.ExclamationTriangleIcon, { className: "h-4" }), /* @__PURE__ */ React.createElement(import_alert.AlertTitle, null, "\u4E8C\u6BB5\u968E\u8A8D\u8A3C\u306E\u8A2D\u5B9A\u306B\u5931\u6557\u3057\u307E\u3057\u305F"), /* @__PURE__ */ React.createElement(import_alert.AlertDescription, null, "\u8A2D\u5B9A\u306E\u8AAD\u307F\u8FBC\u307F\u4E2D\u306B\u30A8\u30E9\u30FC\u304C\u767A\u751F\u3057\u307E\u3057\u305F\u3002\u3082\u3046\u4E00\u5EA6\u304A\u8A66\u3057\u304F\u3060\u3055\u3044\u3002")));
  }
