...
CREATE TABLE public.pages (
  ...
  slug TEXT NOT NULL UNIQUE,           -- ページURL識別子（例: /services/printing/meishi-hagaki-card  または /samples/brochure）
  title TEXT,                          -- ページタイトル
...
CREATE INDEX idx_pages_page_type ON public.pages(page_type);
```
